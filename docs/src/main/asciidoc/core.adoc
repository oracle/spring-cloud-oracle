...
For further details, refer to https://blogs.oracle.com/cloud-infrastructure/post/oke-workload-identity-greater-control-access[OKE Workload Identity Authentication]

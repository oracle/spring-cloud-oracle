...
The `Storage` bean (https://oracle.github.io/spring-cloud-oracle/{project-version}/javadocs/com/oracle/cloud/spring/storage/package-summary.html[Javadoc]) can be used to list, create, update or delete buckets and objects.

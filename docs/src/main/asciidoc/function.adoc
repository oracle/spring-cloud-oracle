...
The `Function` bean (https://oracle.github.io/spring-cloud-oracle/{project-version}/javadocs/com/oracle/cloud/spring/function/package-summary.html[Javadoc]) can be used to invoke a function with parameter inputs 'functionOcid' and 'endpoint'

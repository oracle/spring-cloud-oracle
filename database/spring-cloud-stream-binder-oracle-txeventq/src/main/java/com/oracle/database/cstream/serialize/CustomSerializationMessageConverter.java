...
package com.oracle.database.cstream.serialize;
...
public class CustomSerializationMessageConverter extends SimpleMessageConverter {
    ...
    public Object fromMessage(Message jmsMessage) throws JMSException {
        ...
        if (!isInstanceOfDeserializer) {
            logger.debug("The configured deserializer class is not an instance of 'com.oracle.database.cstream.serialize.DeSerializer'");
            throw new IllegalArgumentException("The configured serializer class is not an instance of 'com.oracle.database.cstream.serialize.DeSerializer'");
        }

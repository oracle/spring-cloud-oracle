...
import com.oracle.database.cstream.serialize.Serializer;
    ...
    protected void jmsHandleMessageInternal(Message<?> message) {
        ...
        if (this.serializerClassName != null) {
            ...
            if (!isInstanceOfSerializer) {
                logger.debug("The configured serializer class is not an instance of 'com.oracle.database.cstream.serialize.Serializer'");
                throw new IllegalArgumentException("The configured serializer class is not an instance of 'com.oracle.database.cstream.serialize.Serializer'");
            }
            Serializer s = null;

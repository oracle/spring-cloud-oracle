...
|-------------------------------------------------------------------------------------------------------------------|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Spring AI Oracle](./spring-ai-oracle/README.md)                                                                  | v2.0.1          | Spring AI integrations for Oracle technologies, like Oracle Cloud Infrastructure Generative AI.                                                                              |
| [Oracle AI Database Spring Boot Starters](./database/starters/README.md)                                          | v26.3.0         | Starters and auto-configuration for Oracle AI Database connectivity, UCP, Wallet, AQ/JMS, OKafka, JSON, spatial, and OpenTelemetry workloads                                 |
| [Spring Cloud OCI](./spring-cloud-oci/README.md)                                                                  | v2.0.4          | Spring Boot integrations for OCI services such as Vault, Object Storage, Streaming, Functions, Queues, Notifications, Email Delivery, Autonomous Database, and Generative AI |
| [Spring Cloud Stream Binder for Oracle TxEventQ](./database/spring-cloud-stream-binder-oracle-txeventq/README.md) | v0.21.0         | A Spring Cloud Stream binder for Oracle AI Database Transactional Event Queues                                                                                               |
...
| Release                   | Reference Docs                                                                 | OCI API Docs                                                                           | Database API Docs                                                                              | Spring AI API Docs                                                                               |
|---------------------------|--------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| Spring Clodu Oracle 2.0.4 | [Reference Docs](https://oracle.github.io/spring-cloud-oracle/site/docs/intro) | [OCI API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.4/javadocs/index.html) | [Database API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.4/javadocs-db/index.html) | [Spring AI  API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.4/javadocs-ai/index.html) |
| Spring Cloud Oracle 2.0.2 | [Reference Docs](https://oracle.github.io/spring-cloud-oracle/site/docs/intro) | [OCI API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.2/javadocs/index.html) | [Database API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.2/javadocs-db/index.html) | N/A                                                                                              |
| Spring Cloud Oracle 2.0.1 | [Reference Docs](https://oracle.github.io/spring-cloud-oracle/site/docs/intro) | [OCI API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.1/javadocs/index.html) | [Database API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.1/javadocs-db/index.html) | N/A                                                                                              |
| Spring Cloud Oracle 2.0.0 | [Reference Docs](https://oracle.github.io/spring-cloud-oracle/site/docs/intro) | [OCI API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.0/javadocs/index.html) | [Database API Docs](https://oracle.github.io/spring-cloud-oracle/2.0.0/javadocs-db/index.html) | N/A                                                                                              |

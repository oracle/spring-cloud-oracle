...
- Expanded the UCP with JPA sample dashboard with pool inventory, lifecycle, and acquisition-duration views, and made pool filtering safe for multi-select values
- Added the `oracle-spring-boot-testcontainers` module with `OracleContainer`, `ADBContainer`, `TrueCacheContainer`, and `OrdsContainer` definitions for the official Oracle AI Database Free and ORDS images
...
- Initial release of Spring AI Oracle, supporting autoconfiguration for OCI Generative AI.
